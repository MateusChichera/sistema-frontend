...
const CadastrosPage = () => {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">Gerenciar Categorias - {empresa.nome_fantasia}</h2>

      {/* Formulário para Adicionar/Editar Categoria */}
      <form onSubmit={editandoCategoria ? handleSaveEdit : handleAddCategoria} className="mb-8 p-4 border rounded-lg bg-gray-50">
      ...
      {/* Lista de Categorias */}
      <h3 className="text-xl font-semibold mb-4 text-gray-700">Categorias Existentes</h3>
      {categorias.length === 0 ? (
